...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, CTRL_5_Pin|CTRL_6_Pin|CTRL_7_Pin|CTRL_8_Pin
                          |CTRL_LED_Pin|CTRL_4_Pin|CTRL_3_Pin|CTRL_2_Pin
  ...
  /*Configure GPIO pins : CTRL_5_Pin CTRL_6_Pin CTRL_7_Pin CTRL_8_Pin
                           CTRL_LED_Pin CTRL_4_Pin CTRL_3_Pin CTRL_2_Pin
                           CTRL_1_Pin CTRL_0_Pin */
  GPIO_InitStruct.Pin = CTRL_5_Pin|CTRL_6_Pin|CTRL_7_Pin|CTRL_8_Pin
                          |CTRL_LED_Pin|CTRL_4_Pin|CTRL_3_Pin|CTRL_2_Pin
                          |CTRL_1_Pin|CTRL_0_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
