...
TEST_F(ACBoard, CorrectBoardParams)
{
    ...
    EXPECT_READ_USB(Contains("-0.1187, -0.1187, -0.1187, -0.1187, 0.00, 0x0"));
}
...
TEST_F(ACBoard, heatsinkLoop) 
{
    ...
    goToTick(100);
    EXPECT_FLUSH_USB(Contains("-0.1187, -0.1187, -0.1187, -0.1187, 54.81, 0x0"));
    EXPECT_FALSE(stmGetGpio(fanCtrl));
    ...
    goToTick(200);
    EXPECT_FLUSH_USB(Contains("-0.1187, -0.1187, -0.1187, -0.1187, 56.42, 0x0"));
    EXPECT_TRUE(stmGetGpio(fanCtrl));
    ...
    ** is outside the function */
    ...
    goToTick(300);
    EXPECT_FLUSH_USB(Contains("-0.1187, -0.1187, -0.1187, -0.1187, 50.78, 0x1"));
    EXPECT_TRUE(stmGetGpio(fanCtrl));
    ...
    goToTick(400);
    EXPECT_FLUSH_USB(Contains("-0.1187, -0.1187, -0.1187, -0.1187, 49.00, 0x1"));
    EXPECT_FALSE(stmGetGpio(fanCtrl));
    ...
    goToTick(600);
    EXPECT_FLUSH_USB(Contains("-0.1187, -0.1187, -0.1187, -0.1187, 70.93, 0xc0000003"));
    EXPECT_TRUE(stmGetGpio(fanCtrl));
