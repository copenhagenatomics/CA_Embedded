...
class PressureCalibrationTest: public ::testing::Test 
{
    protected:
        /*******************************************************************************************
        ** METHODS
        *******************************************************************************************/
        PressureCalibrationTest()
        {
...
TEST_F(PressureCalibrationTest, testCalibrationInit)
{
...
TEST_F(PressureCalibrationTest, testCalibrateBoard)
{
    calibrationInit(&hcrc, &cal, sizeof(cal));
...
TEST_F(PressureCalibrationTest, testCalibrateSensor)
{
    calibrationInit(&hcrc, &cal, sizeof(cal));
...
TEST_F(PressureCalibrationTest, testCalibrationRW)
{
    calibrationInit(&hcrc, &cal, sizeof(cal));
